<?php $this->load->view('dashboard/inc/header'); ?>
    ...
    <div class="row mt">
        <div class="col-sm-12">
            <?php echo form_open_multipart('dashboard/post_store'); ?>
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title pull-right">افزودن پست<i class="fa fa-newspaper-o pull-right"></i></h3>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="body" cols="30" rows="10"
                                      class="form-control"><?= Functions::read('description'); ?></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="panel-heading clearfix">
                                ...
                                <div class="pull-left">
                                    <input type="checkbox" name="visible" id="visible" data-toggle="toggle"
                                           ...
                                           class="form-control pull-left" checked="checked"
                                           data-on="انتشار"
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" id="dateInput" onkeydown="return false;"
                                           ...
                                           value="<?= $this->jdf->jdate('Y/m/d', time(), '', '', 'en'); ?>"
                                    >
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           value="<?= Functions::read('meta_keyword'); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="meta_description" id="meta_description" cols="30" rows="10"
                                              ...
                                              placeholder="تگ متا ..."><?= Functions::read('meta_description'); ?></textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <select name="tags[]" id="tags" class="form-control tags" style="width: 100%"
                                    ...
                                    <?php if (!empty($tags)) : ?>
                                        <?php foreach ($tags as $tag) : ?>
                                            <option value="<?= url_title($tag->slug); ?>"><?= $tag->name; ?></option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
                            </div>
